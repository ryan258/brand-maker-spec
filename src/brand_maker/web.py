  ...
  <main id="main-content">
    <div class="hero">
      <div class="shell hero-grid">
        ...
        <aside class="output-card" aria-label="What each successful kit includes">
          <header>Every successful kit</header>
          <ul><li><span>Strategy</span><span class="tick">✓</span></li><li><span>Voice &amp; personality</span><span class="tick">✓</span></li><li><span>Visual identity</span><span class="tick">✓</span></li><li><span>Campaign concepts</span><span class="tick">✓</span></li><li><span>Quality score</span><span class="tick">✓</span></li></ul>
        </aside>
      </div>
    </div>
